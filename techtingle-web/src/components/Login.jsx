      ...
      <div className="card bg-base-300 w-96 shadow-xl">
        <div className="card-body">
          ...
          <div className="p-4 my-2">
            {error && isWarning && <Alert message={error} isWarning={true} />}
            {error && !isWarning && <Alert message={error} isError={true} />}
            <label className="input input-bordered input-info flex items-center gap-2 p-4 my-4">
              <svg
